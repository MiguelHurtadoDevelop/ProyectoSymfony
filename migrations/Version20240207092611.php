 ...
 */
final class Version20240207092611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE restaurante (id INT AUTO_INCREMENT NOT NULL, correo VARCHAR(60) NOT NULL, clave VARCHAR(60) NOT NULL, pais VARCHAR(50) NOT NULL, cp INT NOT NULL, ciudad VARCHAR(50) NOT NULL, direccion VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
